  ...
  <div class="container-fluid">
    ...
    <template v-if="layoutType === 'twocolumn'">
      <SimpleBar class="navbar-nav" id="navbar-nav">
        ...
        <li class="nav-item">
          <router-link class="nav-link menu-link" to="/questions">
            <i class="ri-honour-line"></i>
            <span data-key="t-widgets">Questions sure</span>
          </router-link>
        </li>
        <li class="nav-item">
          <router-link class="nav-link menu-link" to="/feedback">
            <i class="ri-honour-line"></i>
            <span data-key="t-feedback">Feedback</span>
          </router-link>
        </li>
        <li class="nav-item">
          <router-link class="nav-link menu-link" to="/game_guide">
            <i class="ri-honour-line"></i>
            <span data-key="t-game">Game guide</span>
          </router-link>
        </li>
    ...
    <template v-else>
      <ul class="navbar-nav h-100" id="navbar-nav">
        ...
        <li class="nav-item">
          <router-link class="nav-link menu-link" to="/questions">
            <i class="ri-honour-line"></i>
            <span data-key="t-widgets">Questions</span>
          </router-link>
        </li>
